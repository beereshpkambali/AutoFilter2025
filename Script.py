...
<b>Mʏ Nᴀᴍᴇ Is <a 𝐅𝐢𝐥𝐭𝐞𝐫 𝐁𝐎𝐓 2</a>, I Cᴀɴ Pʀᴏᴠɪᴅᴇ Mᴏᴠɪᴇs, Sᴇʀɪᴇs Jᴜsᴛ Aᴅᴅ Mᴇ Tᴏ Yᴏᴜʀ Gʀᴏᴜᴘ As Aᴅᴍɪɴ EɴJᴏʏ 😍</b>"""

    HELP_TXT = """<b>Hᴇʀᴇ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ Mʏ Cᴏᴍᴍᴀɴᴅs.</b>"""
 
    ABOUT_TXT = """
<b>‣ ᴍʏ ɴᴀᴍᴇ : <a href="https://t.me/abnormalautofilter_bot">𝐅𝐢𝐥𝐭𝐞𝐫 𝐁𝐎𝐓 2</a>
‣ ᴄʀᴇᴀᴛᴏʀ : <a href="https://t.me/i_am_Mr_Abnormal">Mr Abnormal</a>
‣ ʟɪʙʀᴀʀʏ : <a href="https://pyrogram.org/">ᴘʏʀᴏɢʀᴀᴍ</a>
‣ ʟᴀɴɢᴜᴀɢᴇ : <a href="https://www.python.org/">ᴘʏᴛʜᴏɴ</a>
‣ ᴅᴀᴛᴀʙᴀꜱᴇ : <a href="https://www.mongodb.com/">ᴍᴏɴɢᴏ ᴅʙ</a>
‣ ʜᴏꜱᴛᴇᴅ ᴏɴ : <a href="https://www.koyeb.com/">koyeb</a>
</b>"""
...
ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href="https://t.me/about_Mr_Abnormal">Mr Abnormal</a></b>"""
...
Fork our repository and give star ⭐- <a href='https://github.com/Mr-Abnormal'>📥 ᴄʟɪᴄᴋ ʜᴇʀᴇ 📥</a></b>
"""
...
<b>Nᴏᴛᴇ :</b>
1. ɪᴛ ᴡᴏʀᴋs ᴏɴʟʏ ᴡʜᴇɴ ʙᴏᴛ ᴀʟʀᴇᴀᴅʏ ᴄᴏɴɴᴇᴄᴛᴇᴅ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ.
...
<code>/font i love Mr Abnormal Bots</code>"""

    MANUELFILTER_TXT = """Hᴇʟᴘ : <b>Fɪʟᴛᴇʀꜱ</b>
    

<b>Nᴏᴛᴇ :</b>
1.ᴏɴʟʏ ᴀᴅᴍɪɴꜱ ᴄᴀɴ ᴀᴅᴅ ꜰɪʟᴛᴇʀꜱ ɪɴ ᴀ ᴄʜᴀᴛ.
2. ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ ʜᴀᴠᴇ ᴀ ʟɪᴍɪᴛ ᴏꜰ 64 ᴄʜᴀʀᴀᴄᴛᴇʀꜱ.
...
ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ :
<code>[Button Text](buttonurl:https://t.me/i_am_Mr_Abnormal)</code>
...
• /search  - ɢᴇᴛ ᴛʜᴇ ꜰɪʟᴍ ɪɴꜰᴏʀᴍᴀᴛɪᴏɴ ꜰʀᴏᴍ ᴠᴀʀɪᴏᴜꜱ ꜱᴏᴜʀᴄᴇꜱ."""
    ...
    ADMIN_TXT = """<b>Nᴏᴛᴇ :</b>Oɴʟʏ Wᴏʀᴋs Fᴏʀ Mʏ Aᴅᴍɪɴs.
...
𝟹. ᴍᴏᴠɪᴇ ɪs ɴᴏᴛ ᴀᴠᴀɪʟᴀʙʟᴇ ɪɴ ᴛʜᴇ ᴅᴀᴛᴀʙᴀsᴇ ʀᴇᴘᴏʀᴛ ᴛᴏ ᴀᴅᴍɪɴs @about_Mr_Abnormal</b>"""
...
<b>🔰 Cʀᴇᴀᴛᴏʀ : <a href="https://t.me/about_Mr_Abnormal">Mr Abnormal</a></b>"""
...
➻ ᴜᴘɪ ɪᴅ : DM <a href="https://t.me/i_am_Mr_Abnormal">Mr abnormal</a>
